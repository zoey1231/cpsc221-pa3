...
TEST_CASE("twoDtree::basic prune", "[weight=1][part=twoDtree]")
{
    ...
    // img.readFromFile("images/yellow.png");
    //img.readFromFile("images/geo.png");
    ...
    result.writeToFile("images/ada_out.png");
    //result.writeToFile("images/adaPrune_result.png");
    PNG expected;
    expected.readFromFile("images/given-adaPrune.png");
    // expected.readFromFile("images/yellow.png");
